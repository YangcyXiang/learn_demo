...
HD_PWD='D:/special/pj5_temp/pj5_temp.runs/ctrl_storage_pretender_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctrl_storage_pretender_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctrl_storage_pretender_1_0.tcl
