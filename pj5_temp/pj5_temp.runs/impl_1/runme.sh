...
HD_PWD='D:/special/pj5_temp/pj5_temp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ctrl_storage_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ctrl_storage_wrapper.tcl -notrace
