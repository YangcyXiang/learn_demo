...
HD_PWD='D:/special/pj5/pj5.runs/ctrl_storage_rst_ps7_0_5M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctrl_storage_rst_ps7_0_5M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctrl_storage_rst_ps7_0_5M_0.tcl
