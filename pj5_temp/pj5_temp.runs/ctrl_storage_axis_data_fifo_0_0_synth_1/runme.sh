...
HD_PWD='D:/special/pj5/pj5.runs/ctrl_storage_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctrl_storage_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctrl_storage_axis_data_fifo_0_0.tcl
